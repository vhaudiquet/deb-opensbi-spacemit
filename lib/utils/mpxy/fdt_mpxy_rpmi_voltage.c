...
},
{
	...
	.min_tx_len = sizeof(struct rpmi_voltage_get_supported_levels_req),
	.max_tx_len = sizeof(struct rpmi_voltage_get_supported_levels_req),
	.min_rx_len = sizeof(struct rpmi_voltage_get_supported_levels_resp),
	.max_rx_len = -1U,
},
{
